...
<body>
	...
	<c:forEach var="students" items="${request.Scope.students }"> 
				...
				<td>${students.name}</td>
				<td>${students.sur}</td>
				<td>${students.brthno}</td>
				<td>${students.phone}</td>
				<td>${students.email}</td>
				
				<td><a href="edit?email=${customer.brthno }">Edit</a> </td>
				<td><a href="delete?email=${customer.brthno }">Delete</a> </td>
			</tr>
				...
				<div class="col-lg-6 col-lg-offset-3">
					...
					<div class="form-group">
						<label for="surname">Teachers's Surname: </label> <input type="text"
							class="form-control" id="surname" placeholder="Enter Surname" name="surname">
					</div>
